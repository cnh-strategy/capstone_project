...
class HybridDebateSystem:
    ...
    def _load_recent_data_for_debate(self, ticker, days=7):
        try:
            import pandas as pd
    ...
    # ML 예측에 대한 해석 생성
    def _generate_interpretation(self, ml_prediction: float, ticker: str) -> str:
        if ml_prediction > 10:
            trend = "상승"
            confidence = "높음"
    ...
    # 분석 실행
    def run_hybrid_analysis(self, ticker: str, rounds: int = 3) -> Dict[str, Any]:
