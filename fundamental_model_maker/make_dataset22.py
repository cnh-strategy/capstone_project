...
# =========================
# ★ 상대화 feature 추가 (여기 위치해야 함)
# =========================
panel["ni_to_mcap"] = panel["net_income"] / panel["market_cap"]
panel["rev_to_mcap"] = panel["revenue"] / panel["market_cap"]
panel["ocf_to_mcap"] = panel["operating_cashflow"] / panel["market_cap"]

panel["excess_ret"] = panel["ret_1"] - panel["NASDAQ_ret1"]
panel["rel_vol"] = panel["vol_20"] / panel["VIX"]
...
dataset.to_csv("2025/fallback_data22.csv", index=False)
